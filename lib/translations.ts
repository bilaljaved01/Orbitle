  ...
  en: {
    ...
    why: {
      ...
      metrics: [
        ...
        { label: 'Setup vs. Custom Build', change: '6 months → 5 minutes', width: '99%', badge: '99% faster' },
      ...
      points: [
        {
          ...
          desc: 'Building this yourself costs ₹6–7 lakh and takes 6–12 months. Orbitle gives you the same infrastructure in 5 minutes — at a small monthly subscription.',
        },
        {
          icon: '🌐',
    ...
    pricing: {
      ...
      h2a: 'First 20 operators get 30% off —',
      h2b: 'locked for life. Not just the first year.',
      sub: "We're onboarding our first 20 operators at a permanently discounted founding rate. Once we hit 20, this pricing is gone and won't come back.",
      ...
      startingPrice: '₹1,999',
      startingPer: '/mo',
      startingSub: 'Founding rate · First 20 operators · 30% off for life',
      plans: [
        {
          name: 'Monthly',
          price: '₹2,099',
          per: '/mo',
          bill: 'Founding rate — Regular ₹2,999/mo · Cancel anytime',
          featured: false,
          features: [
            'Full platform on your domain',
            'Marketplace + Admin + Agent Portal',
        ...
        },
        {
          ...
          price: '₹1,679',
          per: '/mo',
          bill: 'Founding rate — Regular ₹2,399/mo · Every 6 months',
          featured: true,
          features: [
        ...
        },
        {
          ...
          price: '₹1,399',
          per: '/mo',
          bill: 'Founding rate — Regular ₹1,999/mo · Billed annually',
          featured: false,
          features: [
        ...
        },
        {
          ...
          price: '₹20,999',
          per: 'one-time',
          bill: 'Founding rate — Regular ₹29,999 · Pay once, yours forever',
          featured: false,
          badge: '🔥 Best Deal',
          features: [
      ...
      lockSub: "Express your interest below and we'll share full pricing — including the lifetime plan — right away.",
      lockCta: 'Unlock Pricing →',
      lockNote: 'No commitment required. Founding discount for first 20 operators only.',
      domainNoteTitle: 'Lifetime breakeven = ~10 months',
      domainNote: "At ₹1,399/mo on yearly, you hit the ₹20,999 lifetime price in about 15 months. At the monthly rate you hit it in 10 months. That's a genuinely crazy deal for any operator thinking beyond 1 year. Domain provisioning requires a minimum 6-month plan — or bring your own on any plan.",
    },
    ...
    contact: {
      ...
      points: [
        ...
        '30% off for life — locked in on submission',
        'Full platform live on your domain in 5 minutes',
        'Sell leads to your agents at your own price',
        'Domain included on 6-month & yearly plans',
      ],
      urgencyTitle: 'founding spots remaining',
      urgencyOnly: 'Only',
      urgencySub: 'After the first 20 operators, the founding rate closes permanently.',
